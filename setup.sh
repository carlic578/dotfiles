...
git submodule add git@github.com:vim-scripts/CSApprox.git vi/vim.symlink/bundle/CSApprox
git submodule add git@github.com:scrooloose/nerdcommenter.git vi/vim.symlink/bundle/nerdcommenter
git submodule add git@github.com:scrooloose/nerdtree.git vi/vim.symlink/bundle/nerdtree
git submodule add git@github.com:Lokaltog/powerline.git vi/vim.symlink/bundle/powerline
git submodule add git@github.com:vim-scripts/ScrollColors.git vi/vim.symlink/bundle/ScrollColors
git submodule add git@github.com:ervandew/supertab.git vi/vim.symlink/bundle/supertab
